# Altair — Colombo landmark model

69-level vertical tower, stepped leaning leg, diagonal concrete frame, garden terraces, retail podium and sky garden.

## Included files
- altair.blend: editable Blender 5.1 source, organized architectural collections, PBR materials, preview camera and lighting.
- altair.glb: standalone detailed model; metres, glTF Y up; no external textures needed.
...
Map origin / placement (Three.js X east, Y up, Z south): [-414, 0, 896]; local Blender Z rotation: 0 rad.
