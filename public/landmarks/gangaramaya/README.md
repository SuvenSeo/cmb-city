# Gangaramaya Temple — Colombo landmark model

Main land-based temple compound with an ornate white gateway, gilded roof trim, dagoba, Bodhi enclosure and a terraced sculpture court.

## Included files
- gangaramaya.blend: editable Blender 5.1 source, organized architectural collections, PBR materials, preview camera and lighting.
- gangaramaya.glb: standalone detailed model; metres, glTF Y up; no external textures needed.
...
Detailed mesh: 56,487 triangles. Map mesh: 42,898 triangles.
Dimensions (X / Y / Z in Blender metres): 74.17 / 86.0 / 17.8.

Reference: https://gangaramaya.com/about-us/
...
Map origin / placement (Three.js X east, Y up, Z south): [-190, 0, 1169]; local Blender Z rotation: -1.5707963267948966 rad.
